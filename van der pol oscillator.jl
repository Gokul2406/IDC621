...
# ╔═╡ 8125bef8-1314-11f1-af3a-dddddca9a558
begin
	using Plots
	using DifferentialEquations
end

# ╔═╡ deace8a4-d0cd-4fe5-8cff-f3659ec2a036
function van_der_pol_oscillator!(du, u, μ, t)
	x, y = u
	du[1] = y
	du[2] = μ*(1 - x^2)*y - x
end

# ╔═╡ 0ce709c6-59e5-4257-ba26-41a1994a20ea
begin
	u0 = [1.0; 0.0]
	t_span = (0.0, 250.0)
	p = 4
...
# ╔═╡ 977ffe02-e660-4e1b-a0b4-d40255948236
begin
	prob = ODEProblem(van_der_pol_oscillator!, u0, t_span, p)
	sol = solve(prob, Tsit5(), saveat=0.0001)
end

# ╔═╡ f6e8039f-6b72-4f50-9da6-927a52355fc1
plot(sol[1, :], sol[2, :])

# ╔═╡ ebdc791c-8026-4596-8cd3-3c2e4e86f3ea
begin
	mu = range(0.01, 4.0, length=1000)
	anim = @animate for i in mu
		prob = ODEProblem(van_der_pol_oscillator!, u0, t_span, i)
		sol = solve(prob, Tsit5(), saveat=0.01)
		plot(sol[1, :], sol[2, :])
	end
	gif(anim, "van_der_pol.gif", fps=20)
end
...
manifest_format = "2.0"
project_hash = "ee57f89aca3b311584b93ee8b0721ef47d6785ee"
