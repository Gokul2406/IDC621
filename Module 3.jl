...
# ╔═╡ 605d5f78-2e3a-11f1-ae99-e366c0f06e4c
begin
	using Plots
	using PlutoUI
	using Random
...
# ╔═╡ a8188f18-de08-4654-a1f0-67b7ea595016
html"""
<h1 style="text-align:center;">Term Paper 3</h1>

"""

# ╔═╡ de2ffa5e-9766-465b-b230-75f33a90c598
md"""
This is the final submission towards module 3 of the course IDC621: Modelling Complex Systems for the academic year 2025-2026.

Author:- **Gokul P Bharathan, MS23027**
"""

# ╔═╡ 7d4639b4-f93c-4ab9-a244-976fad7a6ace
md"""
# Packages Used

1. Plots:- The Plots.jl library of pluto is used for plotting.
2. Pluto:- The notebook is made in Pluto.jl
3. Random:- To create a random initial condition for the lattice.
"""
...
md"""
This block contains the code which contains the code related to performing the CML step
"""
...
begin
	func(θ, Ω) = θ + Ω - sin(2*π*θ)/(2*π)
end

# ╔═╡ 6be8e3c3-7dc5-4f26-be86-745cc20569f6
md"""
This part of the code is used for time evolution of the CML
"""

# ╔═╡ 55c81cf5-9add-4d0f-89da-93519c9a8b60
begin
...
# ╔═╡ f0aa7926-0308-40a7-b555-4156454e3fce
md"""
# Spatiotemporal Chaos
In this, section I shall plot the CML for various values for $\Omega$ and $\epsilon$ and show results. I have tried my best at classifying each of the results into the ones mentioned in class. 
"""

# ╔═╡ d468ef01-6ced-4560-857c-85ef81a313b0
md"""
## Homogeneous (Not Very Interesting)
For the set of parameters $\Omega = 0.14$ and $\epsilon = 0.1$ we get a homogeneous map
"""
...
begin
	Ω_homogeneous = 0.14
	ϵ_homogeneous = 0.1
	homogeneous_results = evolve(500, Ω_homogeneous, ϵ_homogeneous, func, 100)
	heatmap(homogeneous_results, xlabel="Lattice site", ylabel="Time", title="Omega = $Ω_homogeneous Epsilon = $ϵ_homogeneous", c = :deep, size=(800, 600))
end
...
The vertical lines creates patterns with a reduce in chaos
"""
...
func_with_2(θ, Ω) = θ + Ω - 2*sin(2*π*θ)/(2*π)
...
begin
	Ω_7_2 = 0.9
	ϵ_7_2 = 0.8006
	func_results_7_2 = evolve(100, Ω_7_2, ϵ_7_2, func_with_2, 100)
	heatmap(func_results_7_2, xlabel="Lattice site", ylabel="Time", title="Omega = $Ω_7_2 Epsilon = $ϵ_7_2", c = :deep, size=(800, 600))
end

# ╔═╡ 4c5c207d-f986-4da1-858b-63e68b641443
md"""
# Reference
1. CML Lecture Slides by Dr. Sudeshna Sinha
"""
...
manifest_format = "2.0"
project_hash = "6861d30a8d66c75977776b58abfbf5cecb42d6d1"
