...
# ╔═╡ cdeb9878-1307-11f1-b512-03bc5f7dae75
begin
	using Plots
...
# ╔═╡ e0f315ba-c71e-424b-9aed-39d6e7f5a22d
...
# ╔═╡ 6f0f0032-5bde-4cca-90c0-a94f1df28fa8
begin
...
# ╔═╡ a8fe7292-40f1-4dc9-b9f6-76a3e46ace32
begin
	prob = ODEProblem(lorenz!, u0, t_span, p)
	sol = solve(prob, Tsit5(), saveat=0.01)
end

# ╔═╡ 2ae3e18f-0ee9-46db-a09b-120351dd0133
begin
	anim = @animate for i in 1:10:length(sol)
		plot(sol[1, 1:i], sol[2, 1:i], sol[3, 1:i],
			lc =:viridis,
			lw = 1.2,
	...
	gif(anim, "lorenz_attractor.gif", fps=40)
end
...
manifest_format = "2.0"
project_hash = "2d17c02312a2f18eeda73a87b83163e4a41e4c9c"
