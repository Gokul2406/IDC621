...
# ╔═╡ 188ab827-dfa3-4701-9b7e-b404019c60eb
begin
	function circular_mask(N::Int, R::Float64)
		"""Parameters
		N => Size of the grid
		R => Galactic radius
		"""
...
# ╔═╡ 5816c0ab-27c5-4d93-a83a-4a584225864b
begin
	mask = circular_mask(500, 200.0)
	heatmap(
		mask,
...
manifest_format = "2.0"
project_hash = "261bfb4f7aed608c29426a3c6b4f60fe5c806693"
...
# ╠═188ab827-dfa3-4701-9b7e-b404019c60eb
# ╠═5816c0ab-27c5-4d93-a83a-4a584225864b
# ╠═f50a96ae-30a6-45b2-96e3-1f5b63a489fb
# ╟─00000000-0000-0000-0000-000000000001
# ╟─00000000-0000-0000-0000-000000000002
